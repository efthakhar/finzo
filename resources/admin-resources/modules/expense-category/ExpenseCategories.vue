...
const expense_categories = computed(() => expenseCategoryStore.expense_categories);
const q_name = ref("");
    ...
    <div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 my-1">
                    <input
                        ...
                        v-model="q_name"
                        @keyup="fetchData(1, expenseCategoryStore.limit, q_name)"
                    />
                </div>
            </div>
        </div>
        ...
        >
            <table class="table mb-0 table-hover">
                ...
                <tbody>
                    <tr v-for="expense_cat in expense_categories" :key="expense_cat.id">
                        <td>
                            <input
                                type="checkbox"
                                class="form-check-input"
