...
const expense_category_data = computed(() => expenseCategoryStore.current_expense_category_item);

async function submitData() {
    expenseCategoryStore
        .addExpenseCat(JSON.parse(JSON.stringify(expenseCategoryStore.current_expense_category_item)))
        .then(() => {
            emit("refreshData");
            emit("close");
        })
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-item">
                            ...
                            <p
                                class="text-danger"
                                v-if="expenseCategoryStore.add_expense_category_errors.name"
                            >
